...
export function Material3Skeleton() {
  return (
    <div className="flex flex-col gap-8 animate-pulse w-full">
      {/* M3 Shimmer Header */}
      <div className="flex justify-between items-center pb-4 border-b border-[#E7E0EC] dark:border-[#49454F]">
        ...
        <div className="flex gap-2">
          ...
          <div className="h-10 bg-[#EADDFF] dark:bg-[#381E72] rounded-full w-24"></div>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-6">
        {[1, 2, 3].map((index) => (
          <div 
            key={index} 
            className="bg-[#F7F2FA] dark:bg-[#1D1B20] border border-[#E7E0EC] dark:border-[#49454F] rounded-3xl overflow-hidden flex flex-col lg:flex-row shadow-sm hover:shadow-md transition-shadow duration-300"
          >
            {/* Left Column: M3 Quiz Ingestion/Question Skeleton */}
            <div className="lg:w-3/5 p-6 lg:p-8 border-b lg:border-b-0 lg:border-r border-[#E7E0EC] dark:border-[#49454F] flex flex-col gap-6">
              <div className="flex items-center gap-3">
                <div className="h-6 bg-[#EADDFF] dark:bg-[#381E72] rounded-full w-14"></div>
              ...
              <div className="space-y-3 mt-2">
                {[1, 2, 3, 4].map((o) => (
                  <div key={o} className="flex items-center gap-3">
                    ...
                    <div className="h-11 bg-white dark:bg-[#2B2930] border border-[#E7E0EC] dark:border-[#49454F] rounded-full flex-1"></div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="lg:w-2/5 p-6 lg:p-8 bg-[#ECE6F0] dark:bg-[#25232A] flex flex-col gap-6">
              <div className="space-y-3">
                ...
                <div className="h-16 bg-white dark:bg-[#1D1B20] rounded-2xl w-full border border-[#E7E0EC] dark:border-[#49454F]"></div>
              </div>

              <div className="space-y-3 flex-1">
                <div className="h-3 bg-[#E7E0EC] dark:bg-[#49454F] rounded-full w-1/2"></div>
                <div className="h-20 bg-[#EADDFF]/50 dark:bg-[#381E72]/20 border border-[#EADDFF] dark:border-[#381E72]/40 rounded-2xl w-full"></div>
              </div>
            </div>
          </div>
        ))}
